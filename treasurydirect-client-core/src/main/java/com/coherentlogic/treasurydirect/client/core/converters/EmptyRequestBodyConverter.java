 ...
 */
public class EmptyRequestBodyConverter implements HttpMessageConverter<Securities> {

    @Override
    public boolean canRead(Class clazz, MediaType mediaType) {
        throw new UnsupportedOperationException("[canRead] The EmptyRequestBody class will never be read; class: " +
    ...
    public Securities read(Class target, HttpInputMessage inputMessage)
        ...
        throw new UnsupportedOperationException("[read] The EmptyRequestBody class will never be read; target: "+ target +
